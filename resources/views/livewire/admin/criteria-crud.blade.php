<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <input type="text" wire:model.live="q" placeholder="Cari kode/nama..." class="rounded-lg border-gray-300">
    </div>
    ...
    <div class="bg-white border rounded-2xl p-4">
        <form wire:submit.prevent="save" class="grid md:grid-cols-4 gap-4">
            <div>
                ...
                <input wire:model="code" class="mt-1 w-full rounded-lg border-gray-300" placeholder="C15">
            </div>
            <div>
                <label class="text-sm">Name</label>
                <input wire:model="name" class="mt-1 w-full rounded-lg border-gray-300" placeholder="Ketinggian">
            </div>
            <div>
                <label class="text-sm">Source</label>
                <select wire:model="source" class="mt-1 w-full rounded-lg border-gray-300">
            ...
            <div>
                ...
                <select wire:model="type" class="mt-1 w-full rounded-lg border-gray-300">
            ...
            <div>
                ...
                <select wire:model="scale" class="mt-1 w-full rounded-lg border-gray-300">
            ...
            <div>
                ...
                <input wire:model="unit" class="mt-1 w-full rounded-lg border-gray-300" placeholder="m / km / 0..10">
            </div>
            <div>
                <label class="text-sm">Min Hint</label>
                <input type="number" step="0.001" wire:model="min_hint" class="mt-1 w-full rounded-lg border-gray-300">
            </div>
            <div>
                <label class="text-sm">Max Hint</label>
                <input type="number" step="0.001" wire:model="max_hint" class="mt-1 w-full rounded-lg border-gray-300">
            </div>
            ...
            <div>
                ...
                <input type="number" wire:model="sort_order" class="mt-1 w-full rounded-lg border-gray-300">
            </div>
